...
import (
	...
	"github.com/codrocker/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/codrocker/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/codrocker/gooxml
